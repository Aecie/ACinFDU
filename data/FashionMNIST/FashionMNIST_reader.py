...
class FashionMNIST_Reader():
    def __init__(self, train_scale: float=1.0, test_scale: float=1.0, use_cuda: bool=False) -> None:
        ...
        self.__test_image_path = os.path.join(os.getcwd(), os.path.join('data/FashionMNIST', 't10k-images-idx3-ubyte'))
        self.__test_label_path = os.path.join(os.getcwd(), os.path.join('data/FashionMNIST', 't10k-labels-idx1-ubyte'))
