...
class MNIST_Reader():
    def __init__(self, train_scale: float=1.0, test_scale: float=1.0) -> None:
        ...
        self.__train_image_path = os.path.join(os.getcwd(), os.path.join('data/MNIST', 'train-images.idx3-ubyte'))
        self.__train_label_path = os.path.join(os.getcwd(), os.path.join('data/MNIST', 'train-labels.idx1-ubyte'))
        self.__test_image_path = os.path.join(os.getcwd(), os.path.join('data/MNIST', 't10k-images.idx3-ubyte'))
        self.__test_label_path = os.path.join(os.getcwd(), os.path.join('data/MNIST', 't10k-labels.idx1-ubyte'))
