"""
This is a FashionMNIST data reader to get train data and test data
"""
...
class FashionMNIST_Reader():
    def __init__(self, train_scale: float=1.0, test_scale: float=1.0, use_cuda: bool=False) -> None:
        ...
        self.__train_image_path = os.path.join(os.getcwd(), os.path.join('database/FashionMNIST', 'train-images-idx3-ubyte'))
        self.__train_label_path = os.path.join(os.getcwd(), os.path.join('database/FashionMNIST', 'train-labels-idx1-ubyte'))
        self.__test_image_path = os.path.join(os.getcwd(), os.path.join('database/FashionMNIST', 't10k-images-idx3-ubyte'))
        self.__test_label_path = os.path.join(os.getcwd(), os.path.join('database/FashionMNIST', 't10k-labels-idx1-ubyte'))
